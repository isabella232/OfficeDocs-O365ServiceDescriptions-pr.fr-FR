...
|:-----|:-----|:-----|
|**Description de service** <br/> |**Rubrique** <br/> |**Remplacez** <br/> |
|Exchange Online  <br/> |[Description du service Exchange Online](exchange-online-service-description/exchange-online-service-description.md) <br/> |Mises à jour pour le chiffrement des données au repos dans le centre de données et chiffrement de messages Office 365 (OME) .  <br/> |
||[Stratégie et conformité de message](exchange-online-service-description/message-policy-and-compliance.md) <br/> |Mises à jour pour le chiffrement des données au repos dans le centre de données et chiffrement de messages Office 365 (OME) .  <br/> |
|Office pour le web  <br/> |[Excel pour le web](office-online-service-description/excel-online.md) <br/> |Mise à jour pour figer la prise en charge des volets Excel sur le Web.  <br/> |
...
|Visio Online  <br/> |[Description du service Visio Online](visio-online-service-description/visio-online-service-description.md) <br/> |Ajout d’une nouvelle page Visio description du service en ligne et mise à jour de plusieurs pages pour refléter cet ajout.  <br/> |
