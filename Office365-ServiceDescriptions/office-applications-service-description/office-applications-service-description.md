...
<sup>2</sup> Azure information protection n’est pas inclus, mais peut être acheté en tant que module complémentaire distinct et permet d’activer les fonctionnalités de gestion des droits relatifs à l’information (IRM). Certaines fonctionnalités Azure information protection requièrent un abonnement à Microsoft 365 apps pour entreprise, qui n’est pas inclus dans Microsoft 365 Business Basic, Microsoft 365 Business standard, Office 365 E1, Office 365 éducation ou Office 365 F3.<br/>
...
<sup>9</sup> l’activation en volume pour Office 365 E3 et les applications Microsoft 365 pour Enterprise sont limitées aux installations sur Windows Server 2008 R2 et versions ultérieures avec le rôle RDS activé ou les installations Windows sur site. Dans les deux cas, les utilisateurs qui accèdent à ces installations doivent être titulaires d’une licence pour les utilisateurs d’Office 365 E3 ou Microsoft 365 applications pour Enterprise.<br/> 
<sup>10</sup> les fonctionnalités Skype entreprise dans Office 365 F3 incluent Skype entreprise plan 1 (pas de partage de bureau, pas de partage d’application, impossible d’initier des conférences audio, vidéo ou Web, impossible de planifier des réunions).<br/> 
...
> <sup>1</sup> Office 2016 pour Mac requiert Mac OS X 10,10 ou version ultérieure. Pour les clients qui se connectent à Exchange via Outlook pour Mac, la connectivité à Microsoft Exchange Server 2010 Service Pack 2 ou version ultérieure est nécessaire. Pour plus d’informations, consultez la rubrique [Microsoft 365 et ressources Office](https://products.office.com/office-system-requirements).<br/>
...
| Application/fonctionnalité Office | GCC | GCC High | DOD |
|-----|-----|-----|-----|
