...
|:-----|:-----|:-----|
|**[Fonctionnalités d’archivage dans Archivage Exchange Online](archive-features.md)** |||
...
|**[Fonctionnalités client dans Archivage Exchange Online](client-features.md)** |||
|Outlook<sup>3</sup> |Oui  |Oui  |
|Outlook sur le web  |Oui  |Oui  |
|**[Fonctionnalités de conformité et de sécurité dans Archivage Exchange Online](compliance-and-security-features.md)** |||
...
|Chiffrement entre clients et archivage Exchange Online  |Oui  |Oui  |
