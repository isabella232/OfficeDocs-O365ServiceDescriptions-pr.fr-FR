...
<br/>
<sup>2 Les</sup> plans Exchange Online Plan 1 et Microsoft 365 Apps ont une limite de taille pour la boîte aux lettres et l’archive. Pour plus d’informations, [consultez les limites d’Exchange Online.](../exchange-online-service-description/exchange-online-limits.md) L'Archivage Exchange Online pour le module complémentaire Exchange Online ajoute une archive informatique illimitée et une [Conservation inaltérable et conservation pour litige](compliance-and-security-features.md#in-place-hold-and-litigation-hold).
