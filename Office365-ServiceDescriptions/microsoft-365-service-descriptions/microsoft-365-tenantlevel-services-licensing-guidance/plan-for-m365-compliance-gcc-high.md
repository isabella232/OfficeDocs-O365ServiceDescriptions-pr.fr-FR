...
| Domaine | Fonctionnalité | GCC High Status |
|------|---------|-----------------|
...
| Étiquetage de la sensibilité | Classification et étiquetage automatiques pour Teams, les groupes Microsoft 365 et les sites SharePoint | Available |
...
| | Gouvernance des informations : stratégies de rétention pour l’enregistrement des réunions Teams | En cours de développement |
...
| Conformité des communications | Prise en charge de Teams, Exchange et possibilité de supprimer un message Teams | Available |
| Conformité des communications | Intégration de Microsoft Teams | On engineering backlog |
| Conformité des communications | Contexte de conversation Teams | On engineering backlog |
...
| Audit | Audit avancé : disponibilité du Centre de sécurité et conformité Microsoft 365 | Available |
