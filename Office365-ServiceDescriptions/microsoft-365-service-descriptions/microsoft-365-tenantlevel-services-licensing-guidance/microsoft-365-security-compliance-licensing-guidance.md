...
- **Explorateur d’activités** [: démarrer avec l’Explorateur d’activités - Conformité Microsoft 365 | Microsoft Docs](https://docs.microsoft.com/microsoft-365/compliance/data-classification-activity-explorer).
