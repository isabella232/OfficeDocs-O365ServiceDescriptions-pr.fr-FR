...
Office Delve permet aux utilisateurs de rechercher et de découvrir du contenu dans Microsoft 365 basé sur des informations personnalisées. Delve est la première expérience fournie par Office Graph. Pour en savoir plus sur Office Delve, reportez-vous à [Qu'est-ce qu'Office Delve ?](https://go.microsoft.com/fwlink/?LinkId=511463). 
