...
Delve permet aux utilisateurs de rechercher et de découvrir du contenu Microsoft 365 en fonction d’informations personnalisées. Delve est la première expérience fournie par Office Graph. Pour en savoir plus sur Delve, voir [Qu’est-ce Delve ?](https://go.microsoft.com/fwlink/?LinkId=511463).
...
* Synchroniser leurs tâches entre Outlook, Teams, planner et bien plus encore
...
Pour plus d’informations, [voir : To Do](https://to-do.microsoft.com/)

## <a name="windows-update-for-business-deployment-service"></a>Service de déploiement de Windows Update pour les entreprises 

Le service Windows Update for Business permet de contrôler l’approbation, la planification et la protection du contenu Windows Update. Il est conçu pour fonctionner avec vos stratégies de mise à jour Windows entreprise existantes afin de fournir un contrôle enrichi sur les mises à jour individuelles. Les fonctionnalités fournies par le service de déploiement sont les suivantes :
...
* Contourner les stratégies de mise à jour Windows pour entreprise pré-configurées pour déployer immédiatement une mise à jour de sécurité au sein de votre organisation
* Assurer la couverture du matériel et des logiciels dans votre organisation via des déploiements adaptés à votre population d’appareils uniques
...
Ces fonctionnalités sont disponibles via les API microsoft Graph et l’intégration avec Microsoft Endpoint Manager. Pour plus d’informations, [voir Windows vue d’ensemble du service de déploiement update for Business.](https://aka.ms/wufb/deployment-service)

## <a name="whiteboard"></a>Tableau blanc collaboratif

Microsoft Whiteboard est une zone libre, numérique où les personnes, le contenu et les idées se rassemblent. Vous pouvez utiliser le tableau blanc pour collaborer avec votre équipe afin d’accomplir de nombreuses activités, que votre équipe se trouve au même endroit ou à plusieurs emplacements. Les membres de l’équipe peuvent travailler en collaboration à l’aide de leurs propres appareils.

Pour plus d’informations Microsoft Whiteboard, voir [Digital Online Whiteboard App - Microsoft Whiteboard](https://www.microsoft.com/microsoft-365/microsoft-whiteboard/digital-whiteboard-app).
