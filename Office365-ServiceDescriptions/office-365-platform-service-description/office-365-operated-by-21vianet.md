...
Microsoft 365 Le Centre de conformité permet d’accéder facilement aux outils dont vous avez besoin pour gérer les besoins de conformité de votre organisation. Les solutions suivantes sont disponibles dans le Centre de conformité pour les plans gérés par 21Vianet :

- Protection contre la perte de données (DLP)
- Rétention
- Audit avec des données provenant de Azure Active Directory et Exchange
- Protection des informations Microsoft (MIP) et étiquettes de niveau de Office clients et Outlook l’aide du client d’étiquette unifiée AIP

> [!NOTE]
> - Les étiquettes de sensibilité pour protéger le contenu SharePoint sites, Microsoft 365 groupes et Microsoft Teams ne sont pas pris en charge pour le moment.
> - Les étiquettes de niveau de sensibilité pour classer et protéger les documents et les e-mails Office sur le Web ne sont pas pris en charge pour le moment.
...
|Administrer Office 365 à l’aide Microsoft 365 centre d’administration Windows PowerShell|Oui|Oui|Oui|Oui|Oui|Oui|Oui|
...
|État des alertes individuelles disponibles dans le tableau de bord Microsoft 365 centre d’administration|Oui|Oui|Oui|Oui|Oui|Oui|Oui|
...
|Créer vos propres rapports à l’aide Microsoft 365 web de création de rapports|Oui|Oui|Oui|Oui|Oui|Oui|Oui|
...
<sup>7 Office 365 Éducation</sup> plans ne viennent pas en charge les changements de licence de licence à partir Microsoft 365'administration centrale.<br/>
...
|[Windows 10 Applications](../office-applications-service-description/office-applications.md#windows-10-apps)|Oui|Oui|Oui|Oui|Oui|Oui|Oui|Oui|Oui|Non|
...
|**Enterprise valeur**|**Office Professionnel Plus 2013 géré par 21Vianet**|**Office Professionnel Plus 2016 géré par 21Vianet**|**Office 365 ProPlus géré par 21Vianet**|**Office 365 Business géré par 21Vianet**|**Office 365 Business Essentials géré par 21Vianet**|**Office 365 Business Premium géré par 21Vianet**|**Office 365 A1 géré par 21Vianet**|**Office 365 Entreprise E1 géré par 21Vianet**|**Office 365 Entreprise E3 géré par 21Vianet**|**Office 365 Entreprise F3 géré par 21Vianet**|
...
|Office prise en charge des ActiveX, des ActiveX et BHO|Oui|Oui|Oui|Non|Non|Oui|Non|Non|Oui|Non|
...
<br/><sup>7 Office 365 ProPlus</sup> est pris en charge sur l’infrastructure VDI (Virtual Desktop Infrastructure) dédiée aux utilisateurs. Office 365 ProPlus prend uniquement en charge les services Bureau à distance s'il est acheté dans le cadre d'un programme de licences en volume.
...
|Microsoft 365 centre d’administration|Oui|Oui|Oui|Oui|Oui|Oui|Oui|
|Excel de rapports|Non|Oui|Non|Non|Oui|Oui|Oui|
...
|Skype Entreprise’intégration|Oui|Oui|Oui|Oui|Oui|Oui|Oui|
...
|Skype Entreprise présence dans OWA et Outlook|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|interopérabilité SharePoint’équipe|Oui|Oui|Oui|Oui|Oui|Oui|Oui|
...
|Microsoft 365'accès au Centre d’administration|Oui|Oui|Oui|Oui|Oui|Oui|Non|
...
|Outlook et Outlook MAPI|Oui<sup>1</sup>|Oui<sup>1</sup>|Oui<sup>1</sup>|Oui<sup>1</sup>|Oui<sup>1</sup>|Oui<sup>1</sup>|Non|
...
|[Microsoft 365 centre d’administration](../exchange-online-protection-service-description/reporting-and-message-trace.md#microsoft-365-admin-center-reports)<br/> |Non<sup>8</sup>|Oui<sup>8, 9</sup>|
...
|[Accès au Centre d’administration Microsoft 365 de gestion](../exchange-online-protection-service-description/administration-and-management-eop.md#access-to-the-microsoft-365-admin-center)<br/> |Oui|Oui|
...
<sup>11</sup> Les prédicats et actions disponibles diffèrent entre EOP et Exchange Online. <br/>
...
|Déploiement d’applications : SharePoint hébergées par des applications|Oui|Oui|Oui|Oui|Oui|Oui|Oui|
...
|BCS : gestion des données métiers composants WebPart|Non|Non|Non|Non|Non|Oui|Non|
...
|SharePoint centre d’administration (Office 365)|Oui|Oui|Oui|Oui|Oui|Oui|Non<sup>4</sup>|
...
|Traduction de documents dans Word sur le Web|Non|Non|Non|Non|Non|Non|Non|
...
|Office sur le Web (créer/modifier)|Oui|Oui|Oui|Oui|Oui|Oui|Oui<sup>8</sup>|
|Office sur le Web (affichage)|Oui|Oui|Oui|Oui|Oui|Oui|Oui|
...
|SharePoint services de traduction automatique|Non|Non|Non|Non|Non|Non|Non|
...
|Visio web<sup>14, 15</sup>|Oui|Oui|Oui|Oui|Oui|Oui|Oui|
...
|Sites et OneDrive hybrides|Oui|Oui|Oui|Oui|Oui|Oui|Oui<sup>15</sup>|
...
|SharePoint ruban|Oui|Non|Oui|Oui|Oui|Oui|Oui|
...
|Flux de site (site d’équipe classique utilisant SharePoint réseau social)|Non|Non|Non|Non|Non|Non|Non|
...
<br/><sup>5 SharePoint</sup> online doivent télécharger et installer l’application gratuite Rank Model Tuning pour créer et personnaliser des modèles de classement.
...
<br/><sup>7 Les</sup> utilisateurs SharePoint Online authentifiés peuvent accéder aux collections de sites privées avec la navigation par facettes.
<br/><sup>8 Les utilisateurs</sup> kiosk ne peuvent pas créer Office documents à l’aide de vignettes en direct. Pour créer un document, les utilisateurs kiosque doivent le faire  à partir d’un site SharePoint Online en sélectionnant Nouveau, puis en sélectionnant un type de fichier (document Word, classe Excel, présentation PowerPoint, bloc-notes OneNote ou enquête Excel) dans le **menu** Créer un nouveau fichier.
...
<br/><sup>11 Les</sup> comptes Kiosk ont des fonctionnalités OneDrive Entreprise limitées. Les clients Kiosk peuvent utiliser l’application OneDrive Entreprise client de synchronisation de dossiers pour synchroniser les bibliothèques de documents du site d’équipe avec un ordinateur partagé et accéder aux documents hors connexion. Toutefois, les comptes kiosque n’incluent pas de site personnel OneDrive Entreprise, ils ne bénéficient donc pas d’une bibliothèque personnelle OneDrive Entreprise avec 1 To ou 5 To de stockage en ligne.
...
|OneNote partage|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|Conférence web ad hoc et de planification|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|Skype Entreprise rendez-vous à une réunion via une audioconférence (première partie)|Non|Non|Non|Non|Non|Non|Non|
|Skype Entreprise rendez-vous de réunion via un fournisseur de services d’audioconférence certifié|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|PowerPoint partage|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|Transfert de fichiers|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|Tableau blanc et annotations|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|PowerPoint chargement|Oui|Oui|Oui|Oui|Oui|Oui|Non|
...
|Accès invité à Skype réunions avec Application Web Skype Entreprise|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|Planifier Skype Entreprise réunions dans Outlook|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|Planifier Skype Entreprise réunions dans Outlook pour le compte d’autres personnes (délégation)|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|Planifier Skype Entreprise réunions avec le programmeur web|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|Planifier des réunions en ligne Outlook sur le web|Oui|Oui|Oui|Oui|Oui|Oui|Non|
|Outlook pour la planification des réunions|Oui|Oui|Oui|Oui|Oui|Oui|Non|
...
|Interopérabilité de la présence avec les Exchange Online|Oui|Oui|Oui|Oui|Oui|Oui|Non|
...
|Outlook l’interopérabilité sur le web|Oui|Oui|Oui|Oui|Oui|Oui|Non|
...
|Skype Entreprise Rapports en ligne dans Microsoft 365'administration centrale|Oui|Oui|Oui|Oui|Oui|Oui|Non|
...
|PowerPoint partage|Non|Oui|
|Tableau blanc et annotations|Non|Oui|
|PowerPoint chargement|Non|Oui|
...
|Accès invité à Skype Entreprise réunions avec Application Web Skype Entreprise|Non|Oui|
|Planifier Skype Entreprise réunions dans Outlook|Non|Oui|
|Planifier Skype Entreprise réunions dans Outlook pour le compte d’autres personnes (délégation)|Non|Oui|
|Planifier Skype Entreprise réunions avec le programmeur web|Non|Oui|
|Planifier des réunions en ligne dans Outlook sur le web|Non|Oui|
|Outlook pour la planification des réunions|Non|Oui|
...
|Interopérabilité de la présence avec les Exchange Online|Oui<sup>5</sup>|Oui|
...
|Outlook l’interopérabilité sur le web|Oui<sup>5</sup>|Oui|
...
## <a name="outlook-features-for-ios-and-android"></a>Outlook pour iOS et Android

Office 365 géré par 21Vianet prend en charge les Outlook pour iOS et Outlook pour Android.
...
|[Enregistrez un Project MPP sur SharePoint](../project-online-service-description/project-publishing.md#save-a-project-mpp-file-on-sharepoint)|Non|Oui|Oui|Oui|Non|
