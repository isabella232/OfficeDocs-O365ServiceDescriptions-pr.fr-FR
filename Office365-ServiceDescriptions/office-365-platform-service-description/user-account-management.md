...
À l’exception des sites Internet pour l’accès anonyme créés avec SharePoint Online, les utilisateurs doivent être authentifiés lors de l’accès services Microsoft. 
...
Avec l’authentification multifacteur, les utilisateurs doivent reconnaître un appel téléphonique, un SMS ou une notification d’application sur leur smartphone après avoir correctement entré leur mot de passe. Ce n'est qu'après cette deuxième authentification que l'utilisateur peut se connecter. Les administrateurs Microsoft peuvent inscrire des utilisateurs pour l’authentification multifacteur dans Microsoft 365 centre d’administration. En savoir plus sur [l’authentification multifacteur.](/office365/admin/security-and-compliance/set-up-multi-factor-authentication)
...
|Expériences Web : Microsoft 365 centre d’administration/ Outlook sur le web/ SharePoint Online/Office sur le Web  <br/> |Connexion à chaque session de navigateur<sup>4</sup> <br/> |Connexion à chaque session <sup>3</sup> <br/> |
...
- Pour renforcer la sécurité, les utilisateurs doivent modifier leur mot de passe lorsqu’ils accèdent pour la première fois à services Microsoft. Par conséquent, avant que les utilisateurs ne peuvent accéder à services Microsoft, ils doivent se connecter au Centre d’administration Microsoft 365, où ils sont invités à modifier leur mot de passe.
