...
Cet article répertorie les fonctionnalités des plans Office 365 Éducation (A1, A3 et A5). Pour comparer les fonctionnalités entre les plans d’entreprise et les plans d’entreprise, consultez comparer les [plans Office 365](https://www.microsoft.com/microsoft-365/business/compare-more-office-365-for-business-plans) pour les entreprises ou, pour obtenir une liste plus détaillée des fonctionnalités, consultez la description de service pertinente sous Descriptions des [services Microsoft 365 et Office 365.](../office-365-service-descriptions-technet-library.md)
  
Pour rechercher des articles et des informations de support, voir [Formation &amp; d’aide Office.](https://support.office.com/)
  
## <a name="service-availability-for-each-plan"></a>Disponibilité des services pour chaque plan

Chaque plan Office 365 Éducation inclut un certain nombre de services individuels, tels qu’Exchange Online et SharePoint Online. Le tableau ci-après présente les services disponibles dans chaque plan Office 365.<br><br>
...
> [!NOTE]
> <sup>1</sup> Microsoft Project n’est pas inclus dans Office 365, mais peut être acquis séparément. Project Online Essentials est gratuit. Si vous êtes un étudiant ou un établissement d’enseignement, vous pouvez acheter Project Plan 3 et Plan 5 à prix éducation.   <br/> 
...
Pour plus d'informations sur les contrats de niveau de service, consultez la rubrique [Contrat de niveau de service](../office-365-platform-service-description/service-level-agreement.md). Pour plus d’informations sur les temps de service récents pour Office 365, consultez Les temps [de travail récents dans le monde](../office-365-platform-service-description/service-health-and-continuity.md#recent-worldwide-uptimes)entier.
  
## <a name="platform-features"></a>Fonctionnalités de la plateforme 

Le tableau suivant répertorie toutes les fonctionnalités de plateforme disponibles dans les plans Office 365 Éducation. Pour plus d’informations sur les tarifs et les fonctionnalités du plan, consultez les [plans Office 365 Éducation.](https://products.office.com/en/academic/compare-office-365-education-plans)<br><br>
...
|Supprimer des comptes et réinitialiser les mots de passe utilisateur d’Office 365 ou à l’aide Windows PowerShell<sup>2</sup> <br/> |Oui  <br/> |Oui  <br/> |Oui  <br/> |
...
|**[État des services et continuité](service-health-and-continuity.md)** <br/> |**Office 365 A1** <br/> |**Office 365 A3** <br/> |**Office 365 A5** <br/> |
|Status information available on the **Service health** or **Service status** page  <br/> |Oui  <br/> |Oui  <br/> |Oui  <br/> |
|État des alertes individuelles disponibles dans le tableau de bord du Centre d’administration Microsoft 365  <br/> |Oui  <br/> |Oui  <br/> |Oui  <br/> |
...
> [!NOTE]
> <sup>1</sup> Office 365 ne prend en charge aucun système d’exploitation non pris en charge par son fabricant.<br/> 
...
<sup>10</sup> L’e-mail Briefing est automatiquement fourni à tous les utilisateurs d’Exchange Online. Pour plus d’informations, [voir Configurer l’e-mail Briefing.](/Briefing/be-admin)<br>
...
<sup>6</sup> Vous pouvez également utiliser l’API Activité de gestion [Office 365](/office/office-365-management-api/office-365-management-activity-api-reference) pour récupérer des événements à partir du journal d’audit unifié. <br/>
...
|[Applications Windows 10](../office-applications-service-description/office-applications.md#windows-10-apps) <br/> |Non<sup>3</sup> <br/> |Oui  <br/> |Oui  <br/> |
...
|**Valeur d’entreprise** <br/> |**Office 365 A1** <br/> |**Office 365 A3** <br/> |**Office 365 A5** <br/> |
...
> - Microsoft Microsoft 365 Apps for enterprise est une offre d’abonnement mensuel de la dernière suite bureautique Office. <br/>
> - Microsoft Office Online Server local des clients obtiennent une licence d’édition Office pour le web s’ils ont acheté une licence de suite bureautique Office (par exemple, une licence Office Professionnel Plus, Office Standard ou Microsoft 365 Apps pour entreprise). 
...
Le tableau suivant répertorie les fonctionnalités Exchange Online disponibles dans les plans Office 365 Éducation.<br><br>
...
|Excel reporting workbook  <br/> |Oui  <br/> |Oui  <br/> |Oui  <br/> |
...
|Intégration de Skype Entreprise  <br/> |Oui  <br/> |Oui  <br/> |Oui  <br/> |
...
|Interopérabilité de SharePoint  <br/> |Oui  <br/> |Oui  <br/> |Oui  <br/> |
...
|Outlook add-ins and Outlook MAPI  <br/> |Oui<sup>7</sup> <br/> |Oui<sup>7</sup> <br/> |Oui<sup>7</sup> <br/> |
...
>- [Résoudre les problèmes liés à Outlook et Office 365 avec l’Assistant Support et récupération Microsoft pour Office 365](https://diagnostics.office.com/)
...
- **Limite de liste** d’adresses : nombre maximal de listes d’adresses qui peuvent être créées dans une organisation Exchange Online Exchange Server 2013. Ce nombre inclut les listes d'adresses par défaut dans Exchange Online, par exemple Tous les contacts et Tous les groupes. 
...
- **Limite des stratégies** de carnet d’adresses : nombre maximal de stratégies de carnet d’adresses créées dans une organisation Exchange Online ou Exchange Server 2013. 
    
- **Listes d’adresses** globales : nombre maximal de listes d’adresses globales (LA GAL) créées dans une organisation Exchange Online ou Exchange Server 2013. 
...
- **Nombre maximal de dossiers publics** : spécifie le nombre maximal de dossiers publics dans la hiérarchie complète des dossiers publics. Lorsque cette limite est atteinte, les dossiers publics existants doivent être supprimés pour pouvoir créer d’autres dossiers publics. 
...
<sup>4 La</sup> taille des messages à déplacer vers Exchange Online est calculée par Exchange Online. Les versions d’Exchange antérieures à Exchange Server 2013 peuvent signaler une taille d’élément inférieure. Cette limite s’applique aux migrations basées sur un déplacement qui utilisent un service de réplication de boîte aux lettres Exchange, quel qu’il soit. La limite générale de taille des messages s’applique à d’autres méthodes de migration (à basculement, intermédiaire, IMAP, PST) et d’autres outils tiers. <br/> 
...
- **Limite de** destinataire : il s’agit du nombre maximal de destinataires autorisés dans les champs À: , Cc et Cci : pour un seul message électronique. 
...
- **Taille maximale de** la boîte aux lettres d’arbitrage : si la boîte aux lettres d’arbitrage dépasse cette limite, les messages nécessitant une modération sont renvoyés à l’expéditeur dans une rapport d’échec de remise. 
...
- **Taux maximal pour les messages** de notification de modération expirés : cette limite définit le nombre maximal de messages de notification pour les messages modérés expirés sur une période d’une heure. Cette limite est définie pour chaque base de données de boîtes aux lettres du centre de données. 
...
- **Exchange ActiveSync limite d’appareil** : nombre maximal d’Exchange ActiveSync par boîte aux lettres. 
    
- **Exchange ActiveSync de** suppression d’appareils : nombre maximal d’appareils Exchange ActiveSync qu’un administrateur Exchange peut supprimer en un mois. 
    
- **Exchange ActiveSync limite de pièces** jointes : taille maximale d’une pièce jointe de message qui peut être envoyée ou reçue par un Exchange ActiveSync électronique. 
...
OneDrive Entreprise (anciennement SkyDrive Pro) est un espace de stockage en ligne personnel dans le cloud. Utilisez-le pour stocker vos fichiers de travail sur plusieurs appareils en toute simplicité et sécurité. Partagez vos fichiers avec vos collègues si nécessaire et modifiez des documents Office en temps réel avec Office pour le web. Synchronisez les fichiers sur votre ordinateur local à l’aide de l’application de synchronisation OneDrive Entreprise.
  
OneDrive Entreprise est inclus dans SharePoint Online et peut également être acheté sous forme de plan autonome. L’option autonome OneDrive Entreprise inclut Office pour le web. Pour en savoir plus, [voir Qu’est-ce que OneDrive Entreprise ?](https://support.office.com/article/187f90af-056f-47c0-9656-cc0ddca7fdc2?ocmsassetID=HA102822076)
  
### <a name="system-requirements"></a>Configuration requise

La demande du client de synchronisation OneDrive Entreprise est différente de celle du client OneDrive. Pour en savoir plus, voir comment installer le client de synchronisation [OneDrive Entreprise.](https://support2.microsoft.com/kb/2903984)
...
Les plans éligibles suivants offrent un espace de stockage OneDrive illimité par utilisateur pour les abonnements avec au moins cinq utilisateurs. Microsoft fournira au départ 5 To d’espace de stockage par utilisateur. Les clients qui souhaitent un espace de stockage OneDrive supplémentaire peuvent le demander si nécessaire en contactant le Support Microsoft. Les abonnements de moins de cinq utilisateurs reçoivent 1 To de stockage par utilisateur.
...
Vous ne pouvez pas allouer plus de stockage à un utilisateur OneDrive spécifique. Toutefois, vous pouvez réduire la quantité de stockage qu’un utilisateur voit. Si un utilisateur Office 365 Entreprise F3 a besoin de davantage de stockage, vous devez mettre à niveau vers Office 365 Entreprise E1.
  
Pour plus d’informations sur les types de fichiers que vous ne pouvez pas ajouter à OneDrive Entreprise, voir Types de fichiers qui ne peuvent pas être ajoutés à une liste ou [une bibliothèque.](https://support.office.com/article/30be234d-e551-4c2a-8de8-f8546ffbf5b3)
...
OneDrive Entreprise Plan 2 est disponible pour Office 365 A1, A3 et A5. Pour afficher les fonctionnalités disponibles dans le plan, consultez la [description du service OneDrive Entreprise.](../onedrive-for-business-service-description.md)
  
## <a name="sharepoint-online-features"></a>Fonctionnalités de SharePoint Online

Pour plus d’informations sur les fonctionnalités SharePoint Online, voir la [description du service SharePoint Online.](../sharepoint-online-service-description/sharepoint-online-service-description.md)

### <a name="sharepoint-online-limits"></a>Limites de SharePoint Online

Le tableau suivant indique les limites de SharePoint pour chaque plan Office 365 Éducation.<br><br>
...
|Numérotation de réunion Skype Entreprise via un fournisseur de services d’audioconférence (ACP) certifié  <br/> |Oui  <br/> |Oui  <br/> |Oui  <br/> |
...
|Chargement De PowerPoint  <br/> |Oui  <br/> |Oui  <br/> |Oui  <br/> |
...
Pour plus d’informations sur les limitations de minute dans les plans d’appels nationaux et internationaux Skype Entreprise Online, consultez les conditions d’utilisation des [services PSTN](/microsoftteams/complimentary-dial-out-period#skype-for-business-pstn-services)de Skype Entreprise Online.
