...
Chaque plan Office 365 éducation inclut un certain nombre de services, tels que Exchange Online et SharePoint Online. Le tableau ci-après présente les services disponibles dans chaque plan Office 365.<br><br>
...
- **Exchange ActiveSync limite d’appareil** : nombre maximal d’appareils Exchange ActiveSync par boîte aux lettres. 
    
- **Exchange ActiveSync limite de** suppression d’appareils : nombre maximal d’appareils Exchange ActiveSync qu’un administrateur Exchange peut supprimer en un mois. 
    
- **Exchange ActiveSync limite de pièces** jointes : taille maximale d’une pièce jointe de message qui peut être envoyée ou reçue par un Exchange ActiveSync de message. 
...
OneDrive Entreprise (anciennement SkyDrive Pro) est un espace de stockage en ligne personnel dans le cloud. Utilisez-le pour stocker vos fichiers de travail sur plusieurs appareils en toute simplicité et sécurité. Partagez vos fichiers avec vos collègues si nécessaire et modifiez Office documents en temps réel avec Office sur le Web. Synchronisez les fichiers sur votre ordinateur local à l’aide de l OneDrive Entreprise de synchronisation.
  
OneDrive Entreprise est inclus dans SharePoint Online et peut également être acheté sous forme de plan autonome. L OneDrive Entreprise option autonome inclut Office sur le Web. Pour en savoir plus, [voir Qu’est-ce OneDrive Entreprise ?](https://support.office.com/article/187f90af-056f-47c0-9656-cc0ddca7fdc2?ocmsassetID=HA102822076).
  
### <a name="system-requirements"></a>Configuration requise

La OneDrive Entreprise client de synchronisation a des exigences système différentes de celles du client OneDrive client. Pour plus d’informations, [voir comment installer le client OneDrive Entreprise synchronisation.](https://support2.microsoft.com/kb/2903984)
  
### <a name="onedrive-for-business-limits"></a>OneDrive Entreprise limites

OneDrive Entreprise Le plan 1 fournit 1 To d’espace de stockage par utilisateur. 
  
Les plans éligibles suivants offrent un OneDrive de stockage illimité par utilisateur pour les abonnements avec au moins cinq utilisateurs. Microsoft fournira au départ 5 To d’espace de stockage par utilisateur. Les clients qui souhaitent obtenir OneDrive stockage supplémentaire peuvent le demander si nécessaire en contactant le Support Microsoft. Les abonnements de moins de cinq utilisateurs reçoivent 1 To de stockage par utilisateur.
...
Vous ne pouvez pas allouer plus de stockage à un utilisateur OneDrive spécifique. Toutefois, vous pouvez réduire la quantité de stockage qu’un utilisateur voit. Si un Office 365 Entreprise F3 a besoin de davantage de stockage, vous devez mettre à niveau vers Office 365 Entreprise E1.
  
Pour plus d’informations sur les types de fichiers que vous ne pouvez pas ajouter à OneDrive Entreprise, voir Types de fichiers qui ne peuvent pas être ajoutés à une liste ou [bibliothèque.](https://support.office.com/article/30be234d-e551-4c2a-8de8-f8546ffbf5b3)
...
OneDrive Entreprise Le plan 2 est disponible pour Office 365 A1, A3 et A5. Pour afficher les fonctionnalités disponibles dans le plan, voir la description [OneDrive Entreprise service.](../onedrive-for-business-service-description.md)
  
## <a name="sharepoint-online-features"></a>Fonctionnalités de SharePoint Online

Pour plus d’informations sur SharePoint online, voir la [description du service SharePoint Online.](../sharepoint-online-service-description/sharepoint-online-service-description.md)

### <a name="sharepoint-online-limits"></a>Limites de SharePoint Online

Le tableau suivant présente les limites SharePoint pour chaque plan Office 365 éducation.<br><br>
...
Le tableau suivant répertorie Skype Entreprise fonctionnalités en ligne disponibles pour chaque plan Office 365 éducation.
  
> [!NOTE]
> Ce tableau indique la disponibilité des clients et des services dans Office 365 options d’enseignement. Si vous souhaitez comparer des fonctionnalités individuelles parmi les différents clients de bureau Skype Entreprise, clients web et clients mobiles, voir [Skype Entreprise Online client comparison tables](/lyncserver/lync-server-2013-desktop-client-comparison-tables) and Mobile Client comparison [tables](/lyncserver/lync-server-2013-mobile-client-comparison-tables). 
...
Pour plus d’informations sur les limitations de minute dans Skype Entreprise Online Domestic and International Calling Plans, voir Skype Entreprise [Online PSTN services use terms](/microsoftteams/complimentary-dial-out-period#skype-for-business-pstn-services).
