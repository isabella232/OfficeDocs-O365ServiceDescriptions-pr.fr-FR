...
Vous pouvez télécharger le client pour votre appareil mobile, PC ou Mac [ici](https://go.microsoft.com/fwlink/?linkid=846929). 
  
Skype Entreprise prend en charge les appareils de salle de conférence répertoriés ici. Pour obtenir plus d'informations, contactez votre équipe de compte ou appelez le [support technique Office 365](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b). Pour obtenir un numéro d'appel local, sélectionnez vos paramètres régionaux dans la liste déroulante.
...
- Afficher leur statut de présence (par exemple : disponible, absent(e), ne pas déranger ou hors connexion) afin de communiquer leur disponibilité. Les informations de présence de Skype Entreprise sont présentées dans la suite Office 365.
    
- Envoyer et recevoir des messages texte en temps réel sur un réseau IP (Internet Protocol) tel qu'Internet ou le réseau d'entreprise d'une organisation. La messagerie instantanée est disponible pour la communication à plusieurs et entre utilisateurs Skype. Le texte MI est crypté pour une sécurité accrue.
    
- Configurer l'affichage de leur propre carte de visite Skype Entreprise.
    
Vous pouvez en savoir plus sur la messagerie instantanée, la présence et les contacts [ici](https://support.office.com/en-US/article/Send-an-IM-in-Skype-for-Business-b3aefb9b-dec8-4be8-a1ee-1eab12144d05).
...
Accédez [ici](https://support.office.com/en-US/article/Set-Audio-Device-options-in-Skype-for-Business-2533d929-9814-4349-8ae4-fca29246e2ff) pour découvrir comment définir les options d'appareil audio dans Skype Entreprise. 
  
## <a name="federation-and-public-im-connectivity"></a>Fédération et connectivité PIC (Public IM Connectivity)
<a name="BKMK_Federation"> </a>

La connectivité externe Skype Entreprise (fédération) permet à un utilisateur Skype Entreprise de contacter des membres d'autres organisations qui utilisent Skype Entreprise, ainsi que ceux qui hébergent leur propre serveur Skype Entreprise local. Les contacts fédérés peuvent afficher la liste des personnes présentes, communiquer par messagerie instantanée, et passer des appels audio et vidéo entre utilisateurs Skype. Toutes les communications fédérées entre les systèmes de messagerie instantanée utilisant des serveurs proxy d'accès sont chiffrées. Microsoft ne contrôle pas le chiffrement une fois les messages transmis au réseau du partenaire fédéré (si le partenaire fédéré dispose d'un serveur Skype Entreprise local ou d'un réseau tiers).
  
La connectivité externe Skype Entreprise nécessite l'accord et la configuration appropriée des deux parties impliquées dans la relation de fédération. Une fois la fédération définie par les administrateurs des deux parties, les utilisateurs de chaque entreprise peuvent afficher la liste des personnes présentes et communiquer avec les utilisateurs de l'autre entreprise. La fédération dans Office 365 est uniquement prise en charge entre d'autres environnements Skype Entreprise, avec des serveurs proxy d'accès ou Edge correctement configurés. Pour obtenir plus d'informations sur la configuration du serveur Edge, consultez la rubrique [Composants requis pour l'accès des utilisateurs externes dans Skype Entreprise Server 2015](https://technet.microsoft.com/en-us/library/gg425779%28v=ocs.15%29.aspx).
  
## <a name="skype-for-business-online-meetings"></a>Réunions Skype Entreprise Online
<a name="BKMK_Meetings"> </a>

Les utilisateurs peuvent démarrer ou rejoindre une réunion Skype Entreprise improvisée en quelques clics dans le client Skype Entreprise ou dans Office. Skype Entreprise permet aux utilisateurs de transformer de simples conversations de messagerie instantanée ou de messagerie électronique en des réunions vidéo et audio sur ordinateur entre plusieurs utilisateurs (deux utilisateurs ou plus) avec la possibilité de partager des bureaux, des applications et des documents.
...
- • Combiner la messagerie vocale et la messagerie électronique pour former une infrastructure de messagerie unique disponible depuis le client Skype Entreprise. La messagerie unifiée Exchange et Skype Entreprise fonctionnent ensemble pour offrir des services de répondeur automatique, Outlook Voice Access et de standard automatique.
    
- Activer Outlook Web App pour fournir des fonctionnalités de messagerie instantanée, de présence, de mises à jour de statut en fonction des informations de calendrier Exchange et de programmation de réunion Skype Entreprise.
...
Pour obtenir plus d'informations, accédez à la rubrique [Qu'est-ce-que la diffusion de réunion Skype](https://support.office.com/en-us/article/What-is-a-Skype-Meeting-Broadcast-c472c76b-21f1-4e4b-ab58-329a6c33757d).
  
Vous pouvez accéder au portail de la diffusion de réunion Skype à l'adresse [http://portal.broadcast.skype.com](http://portal.broadcast.skype.com/).
