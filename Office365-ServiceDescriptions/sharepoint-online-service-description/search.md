...
Les utilisateurs peuvent choisir de trier les résultats de la recherche selon différents critères, par exemple la pertinence, la date et la distance sociale (noms de personnes). En savoir plus sur le [tri des résultats de recherche](https://support.office.com/article/change-settings-for-the-search-results-web-part-40ff85b3-bc5e-4230-b1dd-f088188e487e).
