...
## <a name="cross-browser-support"></a>Prise en charge inter-navigateur
...
## <a name="multi-lingual-user-interface"></a>Interface utilisateur multilingue
...
## <a name="ootb-web-parts"></a>Composants WebPart prêts à l'emploi
...
## <a name="project-site-template"></a>Modèle de site de projet
...
## <a name="site-designs"></a>Modèles de site
...
## <a name="site-usage-page"></a>Page d’utilisation du site
...
## <a name="team-notebook"></a>Bloc-notes de l’équipe
