...
Project pour le web est disponible via trois abonnements : Project Plan 1, Project Plan 3 et Project Plan 5. Les fonctionnalités répertoriées dans la section [Fonctionnalités](#project-for-the-web-features) de Project pour le web interagissent uniquement avec les données du magasin de données Project pour le web.
...
|Créer et utiliser des champs personnalisés de tâche | Ajoutez des champs personnalisés locaux à des tâches dans un projet, ajoutez des données à ces champs ou mettez à jour les données de ces champs.| Afficher uniquement | Oui | Oui | Oui |
|**Collaboration** ||||||
...
|Groupes modernes Office | Créer une équipe de projet avec qui collaborer et configurer facilement une collection de ressources que les membres de l’équipe peuvent partager. | Oui | Oui | Oui | Oui |
...
|Lignes de base | Définissez les lignes de base du projet pour surveiller les performances actuelles par rapport aux performances passées à l’aide de Project Web App.| Oui | Oui |
...
|Tâches récapitulatives | Planifiez, gérez et suivez les livrables et les phases à l’aide de tâches récapitulatifs dans Project Web App. | Oui | Oui |
...
|Chronologies | Suivez visuellement et comprenez les dates, dépendances et affectations de projet sur un affichage chronologique à l’aide de Project Web App. | Oui | Oui |
...
- Pour les abonnements à la version d’essai de Project Online, vos instances d’essai seront supprimées 30 jours après la fin de votre période d’essai.
...
|Longueur durée de la tâche récapitulatif | 3650 jours (10 ans) |
