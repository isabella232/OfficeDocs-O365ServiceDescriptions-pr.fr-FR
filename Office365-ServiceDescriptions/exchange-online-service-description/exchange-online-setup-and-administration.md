...
Pour plus d'informations sur les cmdlets Windows PowerShell utilisables avec Exchange Online, consultez la rubrique [Cmdlets Exchange Online](/powershell/exchange/exchange-online-powershell).
  
### <a name="auditing-for-exchange-online"></a>Audit dans Exchange Online

La fonctionnalité de journalisation d’audit est décrite dans la rubrique suivante : Fonctionnalités [de rapport et outils de dépannage.](reporting-features-and-troubleshooting-tools.md)
